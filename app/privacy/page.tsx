    ...
    <div className="h-screen flex flex-col bg-gradient-to-b from-white to-gray-50 dark:from-[#131314] dark:to-[#1E1E1E]">
      ...
      <div className="flex-shrink-0 bg-white/80 dark:bg-[#131314]/80 backdrop-blur-md border-b border-gray-200 dark:border-[#333537]">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-[#E3E3E3]">Privacy Policy</h1>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">2. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 dark:text-[#E3E3E3] mb-3 mt-4">2.1 Information You Provide Directly</h3>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-[#E3E3E3] mb-3 mt-4">2.2 Information Collected Automatically</h3>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">3. How We Use Your Information</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">4. Data Storage and Retention</h2>
          ...
          {/* 5. Data Sharing */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">5. Sharing Your Information</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">6. Third-Party Services</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
            ...
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mt-4">
          ...
          {/* 7. Data Security */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">7. Data Security</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">8. Your Privacy Rights</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">9. Children&apos;s Privacy</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">10. California Privacy Rights (CCPA)</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">11. European Privacy Rights (GDPR)</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">12. Cookies and Tracking Technologies</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">13. Changes to This Policy</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[#E3E3E3] mb-4">14. Contact Us</h2>
            <p className="text-gray-700 dark:text-[#C4C7C5] leading-relaxed mb-4">
            ...
            <div className="bg-gray-100 dark:bg-[#1E1E1E] p-4 rounded-lg">
              ...
              <p className="text-gray-700 dark:text-[#C4C7C5]">Email: <a href="mailto:privacy@ai-chat.engineer" className="text-blue-600 dark:text-[#8AB4F8] hover:underline hover:text-blue-700 dark:hover:text-[#a3c4fa] transition-colors">privacy@ai-chat.engineer</a></p>
              <p className="text-gray-700 dark:text-[#C4C7C5]">Support: <a href="mailto:support@ai-chat.engineer" className="text-blue-600 dark:text-[#8AB4F8] hover:underline hover:text-blue-700 dark:hover:text-[#a3c4fa] transition-colors">support@ai-chat.engineer</a></p>
          ...
          <section className="mt-12 pt-8 border-t border-gray-200 dark:border-[#333537]">
            <p className="text-gray-600 dark:text-[#C4C7C5] text-sm">
              Related Documents:
            </p>
            <div className="flex gap-4 mt-3 text-sm">
              <Link href="/terms" className="text-blue-600 dark:text-[#8AB4F8] hover:underline hover:text-blue-700 dark:hover:text-[#a3c4fa] transition-colors font-medium">
                Terms & Conditions
              </Link>
